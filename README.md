...
Le code source complet de ce projet est accessible sur ma page github ou ici : https://github.com/morgan-vanvelthem/smartCampusReact

Stack Technique
Back-end : PHP 8, Symfony 6, API Platform

Front-end : JavaScript, React, Twig, HTML/CSS

Base de données : MariaDB / ORM Doctrine
